...
class LLMInference:
    def __init__(self, 
        ...
        # Get basic universal parameters that work across all providers
        self.default_params = {
            "temperature": 0.7,
            "max_tokens": 256,
            "top_p": 1.0,
        ...
        provider_default_params = self.provider.get_default_params()
        for param, value in provider_default_params.items():
